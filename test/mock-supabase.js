...
(function(){
  ...
  const T={
    ...
    profili:[{id:'u1',email:'comitato@test.it',ruolo:'comitato',giudice_id:'g1'},{id:'u2',email:'rossi@test.it',ruolo:'giudice',giudice_id:'g2'},{id:'u3',email:'nuovo@test.it',ruolo:'giudice',giudice_id:null}],
